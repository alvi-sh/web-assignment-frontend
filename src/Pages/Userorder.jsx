...
const UserOrder = () => {
    ...
    const handleCheckout = async () => {
        if (cart.length === 0) {
            toast.error('Cart is empty. Add items to your cart before checkout.', {
                position: 'top-center',
                autoClose: 3000
            });
            return;
        ...
        if (!contactNumber.trim() || contactNumber.trim().length < 10) {
            toast.error('Please enter a valid contact number (at least 10 characters).', {
                position: 'top-center',
                autoClose: 3000
            });
            return;
            ...
            <div className="mx-auto max-w-5xl justify-center px-6 md:px-0">
                <div className="md:flex mb-6">
                    <div className="md:w-2/3 mb-6 md:mb-0">
                            ...
                            <div key={cartItem.cartId}>
                                <div className="mb-6 rounded-lg bg-white p-6 shadow-md">
                                    <div className="text-center md:text-left">
                                        <Link to={`/products/${cartItem.productId}`}><h2
                                            className="text-lg font-bold text-gray-900">{cartItem.title}</h2></Link>
                                        <img
                        ...
                        <p className="text-sm text-gray-700">3. We will call you before order placement so dont
                            worry</p>
