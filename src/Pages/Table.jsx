...
const Table = () => {
    ...
    return (
        <div className="flex flex-wrap gap-6 mt-10 mb-10"
             style={{paddingLeft: "50px", paddingTop: "45px", paddingRight: "5px"}}>
            {filteredProducts.map((product) => (
                <div key={product.productId}
                     className="w-64 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl py-6 ml-4">
                    {product.base64Image ? (
