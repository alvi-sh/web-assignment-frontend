            ...
            <div className="bg-gray-100 mt-20 mb-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="lg:text-center">
                        <h2 className="text-base text-[#4460e6] font-semibold tracking-wide uppercase text-[40px]">Contact
                            Us</h2>
                        ...
                        <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                            ...
                            <div className="flex">
                                <div className="flex-shrink-0">
                                    <div
                                        className="flex items-center justify-center bg-[#4460e6] h-12 w-12 rounded-md  text-white">
                            ...
                            <div className="flex">
                                <div className="flex-shrink-0">
                                    <div
                                        className="flex items-center justify-center h-12 w-12 rounded-md bg-[#4460e6] text-white">
                            ...
                            <div className="flex">
                                ...
                                <div className="ml-4">
                                    ...
                                    <a href="mailto:decorNepal@gmail.com">
                                        <dd className="mt-2 text-base text-gray-500">
