            ...
            <div className="flex flex-col rounded-lg border border-gray-200 bg-white p-6">
                <div className="flex flex-col mb-4">
                    <h2 className="text-lg font-semibold mb-2"
                        style={{textDecoration: "underline", fontFamily: "poppins"}}>Your Information</h2>
                ...
                <div className="flex flex-row gap-3 mb-4">
                    <Link to="/orderdetailuser" className="bg-[#4460e6] text-white py-2 px-4 rounded-md ">Your
                        Orders</Link>
                    <Link to="/userorder" className="bg-[#4460e6] text-white py-2 px-4 rounded-md ">Your Cart</Link>
                    <Link to="/forgotpass" className="bg-[#4460e6] text-white py-2 px-4 rounded-md">Change
                        Password</Link>
                </div>
            </div>
        </div>
