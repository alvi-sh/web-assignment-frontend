        ...
        <span className="text-xl text-white font-bold tracking-wide">
          decorNepal
                ...
                >
                    ...
                    <div
                        className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start gap-6  flex flex-col lg:h-auto justify-center">
                    ...
                    <div
                        className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start gap-3 flex flex-col lg:h-auto justify-center">
                        {user ? (
                            <button
                            ...
                            <Link to="/login"
                                  className="nav-link text-white border-2 p-[4px] rounded-lg hover-bg-grey-300">
                                Register/Login
                            </Link>
                        )}
                        {user && (
